...
CREATE TABLE wp_ndic_request (
  ...
  no_spiral_flag char(1) NOT NULL DEFAULT '',
  in_touch_flag char(1) NOT NULL DEFAULT '',
  prayer_request_flag char(1) NOT NULL DEFAULT '',
  bible_request_flag char(1) NOT NULL DEFAULT '',
  spanish_flag char(1) NOT NULL DEFAULT '',
  no_devotional_flag char(1) NOT NULL DEFAULT '',
  duplicate_flag char(1) NOT NULL DEFAULT 'N',
  details text DEFAULT NULL,
  requesting_friend_id int(11) DEFAULT NULL,
